...
#define DXL_MX_RADIANS_PER_TICK (M_PI*DXL_MX_DEGREES_PER_TICK/180.0)

#define DXL_MX_DEGREES_PER_SECOND_PER_TICK                                   (103.0/150.0)
#define DXL_MX_RADIANS_PER_SECOND_PER_TICK (M_PI*DXL_MX_DEGREES_PER_SECOND_PER_TICK/180.0)

#define DXL_MX_DEGREES_PER_SECOND_SQUARED_PER_TICK                        (2180.0/DXL_MX_MAX_ACCELERATION)
#define DXL_MX_RADIANS_PER_SECOND_SQUARED_PER_TICK (M_PI*DXL_MX_DEGREES_PER_SECOND_SQUARED_PER_TICK/180.0)
